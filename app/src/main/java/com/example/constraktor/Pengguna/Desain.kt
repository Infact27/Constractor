...
@Composable
fun Desain (navController: NavController){
    val uId = ""
    Column(
        ...
        Row(
            ...
            Image(
                painter = painterResource(R.drawable.desainarsitektur),
                contentDescription = null,
                alignment = Alignment.CenterEnd,
                modifier = Modifier
                    .size(160.dp)
                    .clickable { navController.navigate("Arsitektur") }
            )
            Spacer(modifier = Modifier.height(8.dp))
            Image(
                painter = painterResource(R.drawable.desaininterior),
                contentDescription = null,
                alignment = Alignment.CenterEnd,
                modifier = Modifier
                    .size(160.dp)
                    .clickable { navController.navigate("Interior") }
            )
        }
    }
}
